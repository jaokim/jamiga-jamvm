...
#define HAVE_SYS_MMAN 0

//#define timespec timeval
/* Use jamiga allocation stuff*/
//#define JAMIGA 1
#undef JAMIGA_ALLOC
//#define JAMIGA_LOCK 1
//#define JAMIGA_SIG 1
//#define JAMIGA_THREAD 1

#define PATH_SEP ","
#define PATH_SEP_CH ','

/* GNU Classpath installation directory (prefix) */
#define CLASSPATH_INSTALL_DIR "JAmiga:classpath"
// /share

//#define __USE_CLIB2_TIMEVAL 1
...
#undef THREADED
/* comment these, and we're back to normal (change makefiles also*/
/*
*/

// Something's wrong wioht the INLINING
//#define INLINING
#undef INLINING
/*#define THREADED*/
#undef DIRECT
...
/* use zip */
/* Can't use ZIP, since Amiga have noi mmap implementation*/
/* #undef USE_ZIP */
